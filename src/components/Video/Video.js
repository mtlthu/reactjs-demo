...
const Video = ({ url, channel, image, defaultFollow = false, description, song, likes, messages, shares }) => {
    ...
    const handleVolumeChange = (e) => {
        ...
        videoRef.current.attributes[3].value = currentVolume;
        if (e.target.value == 0) {
            setIsMuted(false);
        } else {
            setIsMuted(true);
    ...
    return (
        <div className={cx('wrapper')}>
            <a href="/@channel">
                <div>
                    <span>
                        <img className={cx('user-avatar')} src={image} alt="" />
                    </span>
                </div>
            </a>
            <div>
                ...
                <div className={cx('divVideoWrapper')}>
                    ...
                    <div className={cx('divActionItemContainer')}>
                        ...
                        >
                            ...
                            <strong data-e2e="like-count">{liked ? likes + 1 : likes}</strong>
                        </button>
                        <button
                            type="button"
                            aria-label="Like video727.6K likes"
                        ...
                        >
                            ...
                            <strong data-e2e="like-count">{messages}</strong>
                        </button>
                        <button
                            type="button"
                            aria-label="Like video727.6K likes"
